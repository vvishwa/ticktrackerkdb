...
/home/vijay/q/l64/q /home/vijay/ticktrackerkdb/src/kdbchannel/q/feedhandler/collect.q -ticker TSLA,TSLL,TSLS,NVDA,AMD,SOXL,SOXS,IBIT </dev/null > /tmp/collect.log 2>&1
#cron
